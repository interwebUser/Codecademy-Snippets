# This program creates a min-heap class with the ability to add & retrieve elements to/from
# the heap. The class will also heapify up and down, respectively. This program was 
# written by Khalil Najjar as part of the Codecademy "Career Path: Computer Science"
# Course, Section 8, Complex Data Structures
